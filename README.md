...
4.  **Download Environment Files**
    ...
    -   **Ubuntu/Linux**
        ...
        curl -L -o self-creation-portal/environments/environment.ts https://raw.githubusercontent.com/ELEVATE-Project/survey-project-creation-service/refs/heads/native-setup/documentation/1.0.0/native/envs/enviroment.ts
        ```
