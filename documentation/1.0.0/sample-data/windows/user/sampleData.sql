...
-- Inserting into users_credentials table
INSERT INTO
...
-- Fetching next sequence values
SELECT nextval('users_id_seq'::regclass);

SELECT nextval( 'users_credentials_id_seq'::regclass );