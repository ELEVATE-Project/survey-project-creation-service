...
curl -OJL https://raw.githubusercontent.com/ELEVATE-Project/survey-project-creation-service/readme/documentation/1.0.0/dockerized/scripts/mac-linux/replace_volume_path.sh
...
curl -OJL https://github.com/ELEVATE-Project/survey-project-creation-service/raw/readme/documentation/1.0.0/dockerized/scripts/mac-linux/docker-compose-up.sh
curl -OJL https://github.com/ELEVATE-Project/survey-project-creation-service/raw/readme/documentation/1.0.0/dockerized/scripts/mac-linux/docker-compose-down.sh
...
mkdir -p user && curl -o ./user/distributionColumns.sql -JL https://github.com/ELEVATE-Project/survey-project-creation-service/raw/readme/documentation/1.0.0/distribution-columns/user/distributionColumns.sql
...
curl -OJL https://github.com/ELEVATE-Project/survey-project-creation-service/raw/readme/documentation/1.0.0/dockerized/scripts/mac-linux/citus_setup.sh
...
curl -L https://raw.githubusercontent.com/ELEVATE-Project/survey-project-creation-service/readme/documentation/1.0.0/sample-data/mac-linux/user/sampleData.sql -o sample-data/user/sampleData.sql
...
curl -L -o insert_sample_data.sh https://raw.githubusercontent.com/ELEVATE-Project/survey-project-creation-service/readme/documentation/1.0.0/dockerized/scripts/mac-linux/insert_sample_data.sh && chmod +x insert_sample_data.sh
