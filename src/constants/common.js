...
module.exports = {
	...
	USER_ACTIONS: {
		PROJECTS: {
			RESOURCE_CREATED: 'CREATE_PROJECT',
			RESOURCE_DELETED: 'DELETE_PROJECT',
			RESOURCE_SUBMITTED: 'SUBMIT_PROJECT',
			REVIEW_STARTED: 'PROJECT_REVIEW_STARTED',
			REVIEW_CHANGES_REQUESTED: 'PROJECT_REVIEW_CHANGES_REQUESTED',
			REVIEW_APPROVED: 'PROJECT_APPROVED',
			RESOURCE_PUBLISHED: 'PROJECT_PUBLISHED',
			RESOURCE_REJECTED: 'PROJECT_REJECTED',
			RESOURCE_REPORTED: 'PROJECT_REPORTED',
			REVIEW_INPROGRESS: 'PROJECT_REVIEW_INPROGRESS',
		},
	},
}
